...
{
    [DbContext(typeof(RopaApiContext))]
    [Migration("20231020164920_InitialCreate")]
            ...
            modelBuilder.Entity("Core.Entities.Venta", b =>
                {
                    ...
                    b.HasOne("Core.Entities.FormaPago", "FormasPago")
                        .WithMany("Ventas")
